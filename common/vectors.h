...
#define VECTOR_016      DMA_CH0_Handle     // 0x0000_0040 16     0     DMA              DMA Channel 0 transfer complete
...
#define VECTOR_069      UART1_ISR     // 0x0000_0114 69    53     UART4            Single interrupt vector for UART status sources
...
#define VECTOR_078      FTM0_ISR        // 0x0000_0138 78    62     FTM0 	     Single interrupt vector for all sources
#define VECTOR_079      FTM1_ISR        // 0x0000_013C 79    63     FTM1 	     Single interrupt vector for all sources
